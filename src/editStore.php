...
<div class="container">
    ...
    <h5 class="card-title">Edit Store Id: <?php echo $store->getStoreId() ?></h5>

    <?php
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        $storeName = $_POST["store"];
        if($storeName!=NULL){
            $storesManager->editStoreById($storeId,$storeName);
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="store" value="<?php echo $store->getStoreName() ?>">
